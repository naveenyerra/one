...
<body>
    ...
    <header>
        <div class="container header-container">
            ...
            <nav id="mainNav">
                <ul>
                    <lem><a href="#"><em class="fas fa-home"></em> Home</a></lem>
                    <li class="dropdown">
                    ...
                    <lem><a href="#"><em class="fas fa-fire"></em> Trending</a></lem>
                    <lem><a href="#"><em class="fas fa-percent"></em> Deals</a></lem>
                    <lem><a href="#"><em class="fas fa-info-circle"></em> About</a></lem>
                    <lem><a href="#"><em class="fas fa-envelope"></em> Contact</a></lem>
                </ul>
            </nav>
        ...
        <div class="container">
            <div class="footer-container">
                ...
                <div class="footer-col">
                    <h3>Shop</h3>
                    <ul>
                        <lem><a href="#">All Products</a></lem>
                        <lem><a href="#">Featured Items</a></lem>
                        <lem><a href="#">New Arrivals</a></lem>
                        <lem><a href="#">On Sale</a></lem>
                        <lem><a href="#">Gift Cards</a></lem>
                    </ul>
                </div>
                <div class="footer-col">
                    <h3>Customer Service</h3>
                    <ul>
                        <lem><a href="#">Contact Us</a></lem>
                        <lem><a href="#">FAQs</a></lem>
                        <lem><a href="#">Shipping Policy</a></lem>
                        <lem><a href="#">Returns & Exchanges</a></lem>
                        <lem><a href="#">Track Order</a></lem>
                    </ul>
                </div>
                <div class="footer-col">
                    <h3>About</h3>
                    <ul>
                        <lem><a href="#">Our Story</a></lem>
                        <lem><a href="#">Careers</a></lem>
                        <lem><a href="#">Privacy Policy</a></lem>
                        <lem><a href="#">Terms of Service</a></lem>
                        <lem><a href="#">Blog</a></lem>
                    </ul>
